...
for ( i=1 ; i<=global.gps_partysize ; i++ ) {
	if ( global.party_status[1,i] > 1 ) {
		...
		if ( point_in_rectangle( mouse_x, mouse_y, 2, _y+15+icons_drawn*29, 30, _y+43+icons_drawn*29 )) { stored_tt = i; stored_tt_p = 1 };
...
for ( i=1 ; i<=global.gps_partysize ; i++ ) {
	if ( global.party_status[2,i] > 1 ) {
		...
		if ( point_in_rectangle( mouse_x, mouse_y, 450, _y+15+icons_drawn*29, 478, _y+43+icons_drawn*29 )) { stored_tt = i; stored_tt_p = 2 };
