...
global.bal_basehealth = 45;				//Base Health of a lv0 Creature
global.bal_healthgrowth = 5.5;			//Health growth per level
global.bal_maxenergy = 100;				//Default energy pool size
...
global.bal_startingenergygrowth = 2;	//Starting Energy growth per level
