...
var draw_space_width = oGameController.Resolution_CompleteWidth;
var draw_space_height = oGameController.Resolution_CompleteHeight;
var windowX = 0;
var windowY = 0;
if ( AnchorView ) {
...
//Draw Flat Colour
if ( FlatBack ) { 
	draw_colouredplane(draw_space_x,draw_space_y,draw_space_width,draw_space_height,FlatBack_Colour,FlatBack_Alpha);
	};
