...
var alpha = argument6;
var corner;
if ( argument7 ) { corner[1] = 1 } else { corner[1] = 5 };
if ( argument8 ) { corner[2] = 3 } else { corner[2] = 5 };
if ( argument9 ) { corner[3] = 7 } else { corner[3] = 5 };
if ( argument10 ) { corner[4] = 9 } else { corner[4] = 5 };
...
draw_sprite_ext				(sprite_id,	corner[3],	X+tw+bw,Y,1,1,0,colour,alpha);
//Left Border [Frame 4]
