...
//Attributes
if ( inbattle() ) player.Party_MaxHealth[party_member] = 0;
if ( inbattle() ) player.Party_Health[party_member] = 0;
if ( inbattle() ) player.Party_MaxEnergy[party_member] = 0;
if ( inbattle() ) player.Party_Energy[party_member] = 0;
